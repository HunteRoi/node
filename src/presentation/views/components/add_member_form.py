...
class AddMemberForm():
    ...
    def __init__(self, parent_menu: Menu, community: Community, add_member_usecase: IAddMember):
    ...
    def execute(self):
        ...
        ip_address = self.parent_menu.screen.input(
            "Adresse ip du nouveau membre : ")
